...
<br>
    <p>Haz click en el siguiente enlace:  <a href="${baseUrl}/change/${resetPassToken}">Restablecer Contraseña</a></p>
    <br>
    <p>Si no puedes hacer click en el enlace por favor copia esta URL en el navegador web ${baseUrl}/change/${resetPassToken}</p>
